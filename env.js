 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.expo-ownerexpo.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.expo-obytesexpo'; // ios bundle id
const PACKAGE = 'com.expo.obytesexpo'; // android package name
const NAME = 'obytesExpo'; // app name
const EXPO_ACCOUNT_OWNER = 'isaacwes'; // expo account owner
const EAS_PROJECT_ID = '41cad8f0-e3a7-41b6-8c7c-555fc2d6438d'; // eas project id
const SCHEME = 'obytesExpo'; // app scheme
